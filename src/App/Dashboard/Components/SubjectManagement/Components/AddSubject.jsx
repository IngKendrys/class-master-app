...
export function AddSubject ({ user, subject = {name: "", code: "", group: 1}, isEdit = "", handlePassSubjects, getSubjects }) {
  ...
  function editGroupSubmit() {
    axios
      .patch(`https://api-classmaster.onrender.com/api/subjects/${user.email}/${subject.code}`, 
        {
  ...
  function addGroupSubmit() {
    axios
      .patch(`https://api-classmaster.onrender.com/api/subjects/creategroup/${user.email}/${subject.code}`, 
        {
          groups: [
            {
              name: values.group.toString(),
  ...
  function addSubjectSubmit() {
    axios
      .post(`https://api-classmaster.onrender.com/api/subjects/${user.email}`, 
        {
          code: values.code,
          name: values.name,
          groups: [
